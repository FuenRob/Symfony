...
/**
 * AutorNoticia form base class.
 *
 * @method AutorNoticia getObject() Returns the current form's model object
 *
 * @package    nuevo
 * @subpackage form
 * @author     Daniel López
 ...
 */
abstract class BaseAutorNoticiaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('autor_noticia[%s]');
